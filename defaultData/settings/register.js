...
module.exports = {
  ...
  c: {
    ...
    examNotice:
      '1、仔细阅读题目哦：请在回答问题之前仔细阅读每道题目的要求和说明，确保您充分理解题目的内容。\n2、时间管理：在考试期间，合理分配时间是非常重要的。请注意每道题目的时间限制，并尽量按计划完成答题。\n3、避免抄袭：请务必保证您的回答是原创的。不要抄袭他人的作品或从其他来源直接复制粘贴内容。\n4、仔细检查答案：在提交之前，请仔细检查您的答案。检查是否有拼写错误、格式问题或其他不正确之处。',
  },
};
