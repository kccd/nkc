...
orderRouter
  ...
  .get('/', OnlyUser(), async (ctx, next) => {
    ...
    data.counter = {
      unCost: await db.ShopOrdersModel.countDocuments({
        sellUid: user.uid,
        closeStatus: false,
        orderStatus: 'unCost',
      }),
      unShip: await db.ShopOrdersModel.countDocuments({
        sellUid: user.uid,
        closeStatus: false,
        orderStatus: 'unShip',
      }),
      unSign: await db.ShopOrdersModel.countDocuments({
        sellUid: user.uid,
        closeStatus: false,
        orderStatus: 'unSign',
      }),
      refunding: await db.ShopOrdersModel.countDocuments({
        sellUid: user.uid,
        closeStatus: false,
        refundStatus: 'ing',
      }),
