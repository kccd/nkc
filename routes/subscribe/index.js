      ...
      switch (type) {
        case 'column': {
          ...
          if (subColumnId.length) {
            ...
            subColumnPosts = await db.ColumnPostModel.find(match, {
              pid: 1,
              columnId: 1,
              type: 1,
            })
        ...
        case 'forum': {
          subForumsId = await db.SubscribeModel.getUserSubForumsId(
            data.user.uid,
          );
            ...
            if (t) {
              ...
              thread = {
                ...
                user: {
                  id: column._id,
                  name: column.name,
                  avatar: nkcModules.tools.getUrl(
                    'columnAvatar',
                    column.avatar,
                  ),
                  homeUrl: nkcModules.tools.getUrl('columnHome', column._id),
                ...
                quote: {
                  ...
                  content:
                    document.l === 'json'
                      ...
                      : nkcModules.nkcRender.htmlToPlain(document.content, 200),
