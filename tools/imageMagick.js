...
const watermarkifyFont = (dpi, font, position, path) =>{
  ...
  return spawnProcess('magick', ['mogrify','-font', fontTtf, '-pointsize', '24', '-fill', '#FFFFFF', '-weight', 'bolder','-stroke','#000000','-strokewidth', '0.1','-gravity', position ,'-annotate', dpi, font ,path, path]);
}
