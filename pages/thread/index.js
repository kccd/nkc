...
function postComment(tid, pid) {
  ...
  var subBtn = $('<button onclick="submitPostComment(\''+tid+'\', \''+pid+'\')">提交</button>');
  var quitBtn = $('<button onclick="closePostComment(\''+pid+'\')">取消</button>');
  var editDom = $("<div id='edit_"+pid+"'></div>");
