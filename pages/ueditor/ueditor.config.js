...
(function () {
    ...
    window.UEDITOR_CONFIG = {
		...
		,whitList: {
			a:      ['target', 'href', 'title', 'class', 'style', 'datatype', "contenteditable", "data-tag", "data-type", "data-id"],
			abbr:   ['title', 'class', 'style'],
			address: ['class', 'style'],
			area:   ['shape', 'coords', 'href', 'alt'],
			article: ["style", "data-type", "data-id", "contenteditable", "class"],
			aside:  [],
			audio:  ['autoplay', 'controls', 'loop', 'preload', 'src', 'class', "data-tag", "data-type", "data-id"],
			b:      ['class', 'style'],
			bdi:    ['dir'],
			bdo:    ['dir'],
			big:    [],
			...
			pre:    ['class', 'style', "data-tag", "data-type", "data-id"],
			s:      [],
