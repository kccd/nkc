...
(function () {
    ...
    window.UEDITOR_CONFIG = {
		...
		,whitList: {
			a:      ['target', 'href', 'title', 'style', 'datatype', "contenteditable", "data-tag", "data-type", "data-id"],
			abbr:   ['title',  'style'],
			address: ['style'],
			area:   ['shape', 'coords', 'href', 'alt'],
			article: ["style", "data-type", "data-id", "contenteditable"],
			aside:  [],
			audio:  ['autoplay', 'controls', 'loop', 'preload', 'src', "data-tag", "data-type", "data-id"],
			b:      ['style'],
			bdi:    ['dir'],
			bdo:    ['dir'],
			big:    [],
			...
			del:    ['datetime'],
			details: ['open'],
			div:    ["style", "data-type", "data-id", "contenteditable"],
			dl:     ['style'],
			dt:     ['style'],
			em:     ['style', 'note-tag', 'note-id', 'tag-type', 'contenteditable'],
			...
			pre:    ['style', "data-tag", "data-type", "data-id"],
			s:      [],
			section:["data-tag", "data-type", "data-id", "data-message"],
			small:  [],
			span:   [ 'style', 'contenteditable', 'dataType', 'data-tag', 'data-type', 'data-id'],
			sub:    [ 'style'],
			sup:    [ 'style'],
            strong: [ 'style'],
			...
			u:      [],
			ul:     ['style'],
			video:  ['autoplay', 'controls', 'loop', 'preload', 'src', 'height', 'width',  'style', 'poster', "data-tag", "data-type", "data-id"],
			hidecontent: ["style"],
