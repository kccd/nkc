...
function submit(uid) {
  ...
  var pictureWaterStyleValue = $('#pictureWaterStyle option:selected').attr(
    'data',
  );
  var pictureWaterGravityValue = $('#pictureWaterGravity option:selected').attr(
    'data',
  );
  var videoWaterStyleValue = $('#videoWaterStyle option:selected').attr('data');
  var videoWaterGravityValue = $('#videoWaterGravity option:selected').attr(
    'data',
  );
  optionArr = {
    type: 'save',
    ...
    getAppsWatermark(type) {
      if (type === 'picture') {
        return (
          ...
          type +
          '&style=' +
          this.waterSetting.picture.waterStyle +
          '&time=' +
          Date.now()
        );
      } else {
        return (
          ...
          type +
          '&style=' +
          this.waterSetting.video.waterStyle +
          '&time=' +
          Date.now()
        );
      }
