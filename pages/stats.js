...
var loadChart = function(){
  ...
  .then(function(list){
    ...
    for(i in list){
      ...
      dailyDataset.push(l.postCount)
      dailyDisabled.push(l.postCountDisabled)
      dailyRegister.push(l.userRegistered)

      qualityFactor.push(Math.pow((l.postCount-l.postCountDisabled)/(l.postCount||1),4)*100)
    }
