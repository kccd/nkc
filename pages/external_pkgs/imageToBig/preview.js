(function(){
    ...
    function Preview(opt){
        ...
        this.elemContains = document.getElementsByClassName("wrap");
    ...
    Preview.prototype = {
        ...
        init: function(){
            ...
            for(var c=0; c < this.elemContains.length;c++) {
                this.elemContains[c].addEventListener("click", preview, false)
            }
            ...
            function preview(e){
                ...
                if(tag!=='img' || target.className.indexOf("img-responsive") < 0) return;
